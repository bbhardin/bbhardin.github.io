...
export default function ProjectsPage() {
    ...
    <div className="pageTitle leftAndRightContentInsets">PhD Projects</div>
    <div className="pageSubtitle orangeItalic">ONGOING</div>
    ...
    <div className="leftAndRightContentInsets">
        ...
        <div className="leftContentInsets">
            ...
            <div className="pageSubtitle boxhead leftcon" style={{color: "black", paddingTop: "2rem"}}>Analyzing cyclist
                safety
    ...
    <div className="leftAndRightContentInsets">
        ...
        <div className="leftContentInsets">
            ...
            <div>I'm cleaning and organizing data from event submissions within <a
                ...
                Residents submit points for attending events in order to earn awards for their dorm residence floor. We
            ...
            <div>
                ...
                <ul>
                    <li>Worked with Professor Douglas Comer to implement a new data center architecture based on unique
            ...
            <div>Goal: Add mixed-initiave interface design principles to natural language file search queries to reduce
                the time required to find files.
            </div>

            <div className="topInset"></div>
            <div className="projectSubtitle boxhead"><a href="https://apps.apple.com/us/app/purdue-hcr/id1416403036">Purdue
            ...
            <div className="leftContentInsets">Led the iOS team to develop an app to support the Purdue Honors College
            ...
            <div className="projectSubtitle boxhead"><a
                ...
                Resolutions</a></div>
            <div className="pageSubSubtitle leftContentInsets">(Slightly popular) GitHub guide I wrote on enabling
            ...
            <div className="projectSubtitle boxhead"><a href="https://github.com/bbhardin/DriversFootprint">Driver's
                Footprint</a></div>
            <div className="leftContentInsets"> App I developed for Apple's 2021 WWDC Student Developer Challenge to
            ...
            <div className="topInset"></div>
            <img className='avatar' style={{maxWidth: 100, borderRadius: '15%', float: 'right', marginRight: 50}}
                 src={icon}/>
            <div className="projectSubtitle boxhead"><a
            ...
            <div className="leftContentInsets">
                ...
                <ul>
                    <li>Developing an app to help users reduce food waste by making recipes for their ingredients that
                        expire soon.
                    </li>
                </ul>
            </div>
            ...
            <div className="topInset"></div>
            <div className="projectSubtitle boxhead"><a href="https://github.com/NMerz/DoctorsNote">DoctorsNote</a>
            </div>
            <img className='avatar' style={{maxWidth: 100, borderRadius: '15%', float: 'right', marginRight: 50}}
                 src={dn}/>
            <div className="leftContentInsets">
                <div className="pageSubSubtitle">CS307 Semester Project, Sprint 2020</div>
                <li>Communicated between project coordinator and team, ensuring communication and adherence to course
                    goals.
                </li>
                <li>Guided iOS team, writing front-end and API algorithms, to ensure app fulﬁlled requirements of an
                    encrypted patient-doctor messaging platform.
                </li>
                <li>Organized and led team meetings to promote communication even when working in several timezones

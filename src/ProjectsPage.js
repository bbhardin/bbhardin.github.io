...
export default function ProjectsPage() {
    return (
        ...
        <div>
            ...
            <div className="pageSubtitle orangeItalic" style={{fontWeight:"450", color: "black", fontSize: "70pt", marginLeft: "-10px"}}>PROJECTS</div>
            ...
            <div className="leftAndRightContentInsets">
                ...
                <div className="leftContentInsets">
                    ...
                    <div className="largeLeftContentInsets"><a
                    ...
                    <div className="largeLeftContentInsets">
                        <div className="pageSubSubtitle" style={{fontWeight: "bold", paddingTop: "0.5rem"}}>Utilising
                            past
                            environment
                        ...
                        <div>
                            1. To what extent can previous autonomous system disengagements be used to inform the system
                            of
                            difficult environments?
                            <br/>2. To what extent can previous autonomous system disengagements be used to increase
                            driver
            ...
            <div className="leftAndRightContentInsets">
                ...
                <div className="leftContentInsets">
                    ...
                    <img className='avatar'
                         style={{maxWidth: 200, borderRadius: '10px', float: 'right', marginRight: 50, marginLeft: 20}}
                         src={iv2024}/>
                    ...
                    <div style={{paddingTop: "0.5rem"}}>Much of the research into human factors of remote operation or
                        ...
                        that remotely operated vehicles are hitting the roads, I hope to understand what challenges
                        drivers
                ...
                <div className="leftContentInsets">
                    ...
                    <div>I'm cleaning and organizing data from event submissions within <a
                        href="https://apps.apple.com/us/app/purdue-hcr/id1416403036">the Honors College app</a> that I
                        lead.
                        Residents submit points for attending events in order to earn awards for their dorm residence
                        floor. We
                        are analyzing these submissions from the past two years to
                        collect statistics on event attendance and improve future events.
                    </div>

                    <div className="topInset"></div>
                    <div>
                        <div className="projectSubtitle boxhead"><a href="https://github.com/real-dcnet/dcnet-source">DCnet
                            Research Project</a></div>
                        <div className="pageSubSubtitle">Undergraduate Research with Professor Douglas Comer</div>
                        <ul>
                            <li>Worked with Professor Douglas Comer to implement a new data center architecture based on
                                unique
                                static MAC addresses to provide reliable and quick VM migration.
                            </li>
                    ...
                    <div className="topInset"></div>
                    <div className="pageSubtitle boxhead"><a href="https://github.com/bbhardin/cs592-project">Mixed-Initiative
                        Natural Language File Searcher</a></div>
                    <div className="pageSubSubtitle">CS592 Human-AI Interaction Course Project</div>
                    <div>Goal: Add mixed-initiave interface design principles to natural language file search queries to
                        reduce
                        the time required to find files.
                    </div>

                    <div className="topInset"></div>
                    <div className="projectSubtitle boxhead"><a
                        href="https://apps.apple.com/us/app/purdue-hcr/id1416403036">Purdue
                        Honors College & Residences App </a></div>
                    ...
                    <div className="leftContentInsets">Led the iOS team to develop an app to support the Purdue Honors
                        College
                        and Residences in their house
                        competition system. The system incentives residents to participate in the college and earn more
                        points
                        than other dorm floors. The app is used by over 900 students and faculty and also includes
                        features such
                    ...
                    <div className="topInset"></div>
                    <div className="projectSubtitle boxhead"><a
                        href="https://github.com/bbhardin/A-Guide-to-MacOS-Scaled-Resolutions">A Guide to MacOS Scaled
                        Resolutions</a></div>
                    <div className="pageSubSubtitle leftContentInsets">(Slightly popular) GitHub guide I wrote on
                        enabling
                        scaled resolution support in MacOS.
                    </div>

                    <div className="topInset"></div>
                    <div className="projectSubtitle boxhead"><a href="https://github.com/bbhardin/DriversFootprint">Driver's
                        Footprint</a></div>
                    <div className="leftContentInsets"> App I developed for Apple's 2021 WWDC Student Developer
                        Challenge to
                        predict a user's carbon footprint
                        based on how much they drive to work. It compares the number of trees you would have to plant
                        each year
                        to offset your driving as well as how many hamburgers you would have to avoid eating to offset
                        your
                    ...
                    <div className="topInset"></div>
                    <img className='avatar'
                         style={{maxWidth: 100, borderRadius: '15%', float: 'right', marginRight: 50}}
                         src={icon}/>
                    <div className="projectSubtitle boxhead"><a
                        href="https://apps.apple.com/us/app/skill-zone-play-to-the-top/id1576326199">SkillZone</a></div>
                    <div className="leftContentInsets">
                        <div className="pageSubSubtitle">Minigame iOS App</div>
                        <ul>
                            <li>Helped develop components of a mini game app with over 99,000 users.</li>
                        </ul>
                    </div>
                    ...
                    <div className="topInset"></div>
                    <div className="projectSubtitle boxhead"><a href="https://github.com/PallavAg/Appetyte">Appetyte</a>
                    </div>
                    <div className="leftContentInsets">
                        <div className="pageSubSubtitle">CS407 Semester Project, Fall 2022</div>
                        <ul>
                            <li>Developing an app to help users reduce food waste by making recipes for their
                                ingredients that
                                expire soon.
                            </li>
                        </ul>
                    ...
                    <div className="topInset"></div>
                    <div className="projectSubtitle boxhead"><a
                        href="https://github.com/NMerz/DoctorsNote">DoctorsNote</a>
                    </div>
                    <img className='avatar'
                         style={{maxWidth: 100, borderRadius: '15%', float: 'right', marginRight: 50}}
                         src={dn}/>
                    <div className="leftContentInsets">
                        ...
                        <li>Communicated between project coordinator and team, ensuring communication and adherence to
                            course
                            goals.
                        </li>
                        <li>Guided iOS team, writing front-end and API algorithms, to ensure app fulﬁlled requirements
                            of an
                            encrypted patient-doctor messaging platform.
                        </li>
                        <li>Organized and led team meetings to promote communication even when working in several
                            timezones

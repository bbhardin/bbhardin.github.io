...
export default function ProjectsPage() {
    return (
        <div className="leftAndRightContentInsets">
            ...
            <div className="pageSubtitle"><a href="https://github.com/bbhardin/DriversFootprint">Driver's Footprint</a></div>
            <div> App I developed for Apple's 2021 WWDC Student Developer Challenge to predict a user's carbon footprint
            ...
            <div className="pageSubtitle"><a href="https://github.com/bbhardin/smart-light-control">Smart Light Control from a Mercedes Window Switch Panel</a></div>
            <div>A simple smart light control panel using IFTTT hooks built on a window switch control panel from a 2001
            ...
            <div className="pageSubtitle"><a href="https://github.com/NMerz/DoctorsNote">DoctorsNote</a></div>
